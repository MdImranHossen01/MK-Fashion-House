...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      title: {
        default: settings.metaTitle || settings.brandName || "MK Fashion House",
        template: `%s | ${settings.brandName || "MK Fashion House"}`,
      },
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "MK Fashion House",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "MK Fashion House",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "MK Fashion House",
        type: 'website',
      },
      twitter: {
