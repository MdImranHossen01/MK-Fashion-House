...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = aiConfig.systemPrompt || 'You are a helpful e-commerce assistant for MK Fashion House.';
    ...
    const openai = new OpenAI({
      ...
      defaultHeaders: {
        ...
        'X-Title': `${settings?.brandName || 'MK Fashion House'} - AI Assistant`,
      },
    });
