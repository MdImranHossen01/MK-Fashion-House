  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "MK Fashion House",
        contact: {
        ...
        marqueeText: "Welcome to MK Fashion House!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "MK Fashion House",
