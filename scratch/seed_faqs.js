...
const faqs = [
  {
    question: "What is MK Fashion House?",
    answer: "MK Fashion House is a multi-version e-commerce platform designed to customize and deploy tailored online storefronts for various clients using modular UI component versions (V1 to V6).",
    order: 1,
    isActive: true
  },
  {
  ...
  {
    question: "Does MK Fashion House support MongoDB?",
    answer: "Yes, MK Fashion House uses MongoDB as its primary database to store product details, orders, client configurations, and global settings securely.",
    order: 4,
    isActive: true
  },
  {
